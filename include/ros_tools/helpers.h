 ...
 */
template <class T> inline T InterpolateLinearly(double start, double end, double value, const T &lower, const T &upper)
{
  double lambda = (value - start) / (end - start);
...
template <class T> class StatisticAnalysis
{
public:
  StatisticAnalysis()
  {
