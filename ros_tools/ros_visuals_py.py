...
class ROSMarkerPublisher(Node):

    """
    Collects ROS Markers
    """

    def __init__(self, node, topic, frame_id, max_size):
        super().__init__('ros_marker_publisher', namespace=node.get_namespace())
        
        self.pub_ = self.create_publisher(MarkerArray, topic, 1)
